...
# 封装 SELECT, INSERT, UPDATE, DELETE 等操作。


# 全局命名空间中声明一个变量 __pool
# __pool = ''
...
# INSERT, UPDATE, DELETE 语句，execute 函数
@asyncio.coroutine
...
class Model(dict, metaclass=ModelMetaclass):
    ...
    # todo 3 类方法的声明：类方法的第一个参数是 cls，而实例方法的第一个参数是 self
    @classmethod
